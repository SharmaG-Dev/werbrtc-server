...
const Authentications = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    try {
        jsonwebtoken_1.default.verify(token, process.env.JWT_SECRET, (err, decoded) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const { email } = decoded;
            const userSevice = new user_service_1.default();
            const userInfo = yield userSevice.getUser({ email });
            req.User = userInfo;
            next();
        }));
    }
